...
base_herois.loc[base_herois.Publisher == 'Marvel Comics', 'Publisher'] = 0
base_herois.loc[base_herois.Publisher == 'Outhers', 'Publisher'] = 1
...
previsores = KNN(k = 3, orientation="rows", normalizer=None).fit_transform(previsores)
...
plt.plot(fprTREE, tprTREE, '', label="Publisher, auc= %0.2f"% aucTREE)
...
# Uso de biblioteca para Plotagem de Gráfico
plt.plot(fprNB, tprNB, '', label="Publisher, auc= %0.2f"% aucNB)
plt.title('Receiver Operating Characteristic')
plt.xlabel('False Positive')
plt.ylabel('True Positive')
plt.legend(loc=4)
...
# Uso de biblioteca para Plotagem de Gráfico
plt.plot(fprRF, tprRF, '', label="Publisher, auc= %0.2f"% aucRF)
plt.title('Receiver Operating Characteristic')
plt.xlabel('False Positive')
plt.ylabel('True Positive')
plt.legend(loc=4)
