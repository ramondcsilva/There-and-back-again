# -*- coding: utf-8 -*-
"""
Created on Mon Aug 26 20:40:14 2019
...
#resultado da avaliação cruzada feita com 6 testes. k=6

resultados = cross_val_score(classificadorNB, previsores, classe, cv = 6)
