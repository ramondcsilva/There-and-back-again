...
# Criando variaveis para treinamento e teste, usando o metodo de divisao dos dados
# Usou-se 15%(test_size = 0.15) como quantidade de atributos para teste e o restante para treinamento
previsores_treinamentoNB, previsores_testeNB, classe_treinamentoNB, classe_testeNB = train_test_split(previsores, classe, test_size=0.15, random_state=0)
...
#resultado da avaliação cruzada feita com 5 testes. k=5

resultados = cross_val_score(classificadorNB, previsores, classe, cv = 5)
